export default function DrawBanner({ username = "Somu Singh", gameName, drawTime = "03-04-2026 13:00:00", bannerUrl }) {
        ...
        >
            ...
            <div className="relative z-10 flex justify-between items-start px-4 py-3">
                <div>
                    ...
                    <p className="text-purple-200 font-bold text-[11px] mt-0.5">
                        {`${formatGameName(gameName)} Draw`}
                    </p>
