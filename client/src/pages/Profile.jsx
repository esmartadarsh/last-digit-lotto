  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (editAvatar) {
        ...
        const imgRef = ref(
          storage,
          `profile-images/avatar_${user.id}_${Date.now()}.webp`,
        );
        const snapshot = await uploadBytes(imgRef, editAvatar, {
    ...
    <>
      <div className="pb-4">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #dc2626 0%, #b91c1c 40%, #7c3aed 100%)",
          }}
        >
          {/* Decorative circles */}
            ...
            <div className="relative inline-block mb-4">
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 0 3px #dc2626, 0 8px 24px rgba(220,38,38,0.3)",
          ...
          >
            {MENU_ITEMS.map((item, idx) => (
              <button
                ...
                style={{
                  borderBottom:
                    idx < MENU_ITEMS.length - 1 ? "1px solid #f9fafb" : "none",
                }}
              >
                <div className="flex items-center gap-3">
                  ...
                  >
                    <item.icon
                      style={{ width: 18, height: 18, color: item.iconColor }}
                    />
                  </div>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col items-center mb-6">
                <div className="relative">
                  <div
                    className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-lg bg-gray-100 flex items-center justify-center"
                    style={{
